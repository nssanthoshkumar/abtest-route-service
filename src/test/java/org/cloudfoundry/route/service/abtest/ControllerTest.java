...
import static org.cloudfoundry.route.service.abtest.Controller.COOKIE;
import static org.cloudfoundry.route.service.abtest.Controller.FORWARDED_URL;
import static org.cloudfoundry.route.service.abtest.Controller.PROXY_METADATA;
import static org.cloudfoundry.route.service.abtest.Controller.PROXY_SIGNATURE;
...
import org.cloudfoundry.route.service.abtest.ABTestRouteServiceApplication;
...
@SpringApplicationConfiguration(classes = ABTestRouteServiceApplication.class)
@WebAppConfiguration
@TestPropertySource(properties={"route.service.abtest.domainA= localhost"})
public class ControllerTest {
    ...
    @Test
    @Ignore	// Ignoring test case as the status is unpredictable due to AB url selected randomly to serve or redirect
    ...
    public void patchRequest() throws Exception {
        this.mockServer
            ...
            .andExpect(header(PROXY_METADATA, PROXY_METADATA_VALUE))
            .andExpect(header(PROXY_SIGNATURE, PROXY_SIGNATURE_VALUE))
            .andExpect(header(COOKIE, "JSESSIONID=12345"))
        ...
        this.mockMvc
            .perform(patch("http://localhost/route-service/patch")
                ...
                .header(PROXY_METADATA, PROXY_METADATA_VALUE)
                .header(PROXY_SIGNATURE, PROXY_SIGNATURE_VALUE)
                .header(COOKIE, "JSESSIONID=12345")
